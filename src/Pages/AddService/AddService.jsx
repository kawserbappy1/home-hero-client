...
const AddService = () => {
      ...
      .then((data) => {
        Swal.fire({
          ...
          customClass: {
            ...
            htmlContainer: "responsive-swal-content",
          },
        });
        navigate("/");
      })
  ...
  return (
    <>
      <Helmet>
        <title>Hero Home || Add Service</title>
      </Helmet>
        ...
        >
          ...
          <div>
            ...
            <select
              name="category"
              required
              className="w-full border rounded-md p-2 bg-bg1 focus:ring-2 focus:ring-greenColor"
            >
