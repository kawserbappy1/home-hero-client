...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Hero Home || All Services </title>
      </Helmet>
      <div className=" pb-10">
        <ServicePageBanner />
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between py-10 gap-4 px-2">
          ...
          <select
            ...
            className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring focus:ring-greenColor bg-bg1"
          >
            {filters.map((filter) => (
